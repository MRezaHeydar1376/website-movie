    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                const responseTVTopRated = await tmdbApi.getTvList(TvType.top_rated, 1)
                ...
                setTvTopRated(responseTVTopRated.data.results.slice(1, 20))
            }
            catch (error) {
                console.log(error)
            }
    ...
    return (
        <Div>
            ...
            <Div width="98%" margin="0 auto">
                ...
                <Slider movies={tvTopRated} title={"Top Rated TV"} />
            </Div>
        </Div>
    );
}
